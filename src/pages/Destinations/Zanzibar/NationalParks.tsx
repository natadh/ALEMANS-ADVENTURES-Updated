...
import { zanzibarNationalParksData } from "./NationalParksInfo";
import { zanzibarPopularParksData } from "./PopularParksInfo";
import { zanzibarConservanciesData } from "./ConservanciesInfo";


interface ParkSubsection {
    subheader: string;
    content?: string;
}
...
export default function ZanzibarParks() {
  ...
  const data =
    category === "national"
      ? zanzibarNationalParksData
      : category === "popular"
      ? zanzibarPopularParksData
      : zanzibarConservanciesData;
  ...
  const CATEGORY_OPTIONS: { label: string; value: ParkCategory }[] = [
    ...
    { label: "All National Parks", value: "national" },
  ...
  if (!activePark) {
    return <div className="p-8">No park data available. Please import your data files.</div>;
  }
